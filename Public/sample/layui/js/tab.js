...
layui.define(['element', 'common'], function(exports) {
	...
	Tab.prototype.tabAdd = function(data) {
		...
		if(tabIndex === -1) {
			...
			title += '<i class="fa fa-refresh distance" data-id="' + globalTabIdIndex + '"></i>';

			if(thispageclosed==true) {
	...
	//刷新页面
	$('.layui-tab-title').on('click','.fa', function() {
